...
<table width="98%" border="0" cellpadding="5" cellspacing="0" class="inscription">
	...
	<tr style="background: #e8e8e8">
      <td class="text">Comprobaci&oacute;n, &iquest;cu&aacute;l es el resultado de 2+5? : </td>
	  <td><input type="text" name="ccir43" size="50" value="" /></td>
    </tr>
	<tr style="background: #e8e8e8">
      <td class="text">T&iacute;tulo libro 1 :</td>
	  <td><input type="text" name="films[0]" size="50" value="<? echo $campos['films'][0] ?>" /></td>
    </tr>
	<tr style="background: #e8e8e8">
      <td class="text">T&iacute;tulo libro 2 :</td>
	  <td><input type="text" name="films[1]" size="50" value="<? echo $campos['films'][1] ?>" /></td>
    </tr>
	<tr style="background: #e8e8e8">
      <td class="text">T&iacute;tulo libro 3 :</td>
	  <td><input type="text" name="films[2]" size="50" value="<? echo $campos['films'][2] ?>" /></td>
    </tr>
	<tr style="background: #e8e8e8">
      <td class="text">T&iacute;tulo libro 4 :</td>
	  <td><input type="text" name="films[3]" size="50" value="<? echo $campos['films'][3] ?>" /></td>
    </tr>
	<tr style="background: #e8e8e8">
      <td class="text">T&iacute;tulo libro 5 :</td>
	  <td><input type="text" name="films[4]" size="50" value="<? echo $campos['films'][4] ?>" /></td>
    </tr>	
	<tr>
	...
	<tr>		
		<td class="text">Comentarios: </span> </td>
...
function valida_form_concurso($nombre="",$films = array(), $email="") {
	...
	if($count>2)
		set_error("Debes escribir al menos 3 libros");
...
function cuantas_concurso_participaciones(){
	global $siteDB;
	$result = $siteDB->query("SELECT name FROM concurso_libros");
...
function dame_y_pinta_participaciones(){
	...
	arsort($total_films);
	echo '<ul>';
	foreach($total_films as $key => $value)
